...
- hosts: $host
  ...
  tasks:
    ...
    - name: install MySQL for RedHat 7/Kylin10/openEuler/UnionTech kongzi/Nfs/LinxOS-EL from local
      when: (ansible_os_family == 'RedHat' and ansible_distribution_major_version >= 7 and yum_repo != 'false') or ansible_os_family == 'Kylin' \
            or ansible_os_family == 'Openeuler' or ansible_os_family == 'LinxOS-EL' or ansible_os_family == 'Nfs' or (ansible_os_family == 'UnionTech' and ansible_distribution_release == 'kongzi')
    ...
    - name: open 3306 port on RedHat 7/Alibaba/Kyliin10/openEuler/UnionTech kongzi/Nfs/LinxOS-EL
      when: ansible_os_family == 'RedHat' or ansible_os_family == 'Alibaba' or (ansible_os_family == 'Kylin' and ansible_distribution_version == '10')
            or ansible_os_family == 'Nfs' or ansible_os_family == 'LinxOS-EL' or (ansible_os_family == 'UnionTech' and ansible_distribution_release == 'kongzi')
    ...
    - name: enable MySQL daemon on RedHat 7/Kyliin10/openEuler/UnionTech kongzi/Nfs/LinxOS-EL
      when: (ansible_os_family == 'RedHat' and ansible_distribution_major_version >= 7) or ansible_os_family == 'Kylin' or ansible_os_family == 'LinxOS-EL' or ansible_os_family == 'Openeuler'
