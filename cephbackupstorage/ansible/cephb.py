...
if distro == "RedHat" or distro == "CentOS":
    if zstack_repo != 'false':
        command = ("pkg_list=`rpm -q wget qemu-img-ev-2.3.0 libvirt libguestfs-winsupport libguestfs-tools | grep \"not installed\" | awk '{ print $2 }'` && for pkg"
        ...
        for pkg in [ "wget", "qemu-img-ev-2.3.0", "libvirt", "libguestfs-winsupport", "libguestfs-tools"]:
