...
if distro == "RedHat" or distro == "CentOS":
    ...
    command = "service zstack-fusionstor-primarystorage stop &&  service zstack-fusionstor-primarystorage start && update-rc.d zstack-fusionstor-primarystorage enable"
run_remote_command(command, host_post_info)
