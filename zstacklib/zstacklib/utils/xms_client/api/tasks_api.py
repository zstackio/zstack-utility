...
class TasksApi(object):
    ...
    def get_task(self, task_id, **kwargs):  # noqa: E501
        ...
        get a task info  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_task(task_id, async=True)
        >>> result = thread.get()
    ...
    def get_task_with_http_info(self, task_id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_task_with_http_info(task_id, async=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            ...
            response_type='TaskResp',  # noqa: E501
    ...
    def list_tasks(self, **kwargs):  # noqa: E501
        ...
        List tasks by fileter  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        ...
        :param int host_id: host running the task
        :return: TasksResp
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def list_tasks_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['status', 'type', 'host_id']  # noqa: E501
        all_params.append('async')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='TasksResp',  # noqa: E501
            auth_settings=auth_settings,
            async=params.get('async'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
