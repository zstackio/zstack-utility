...
class FsUsersApi(object):
    ...
    def list_fs_users(self, **kwargs):  # noqa: E501
        ...
        :param bool available: available user or not
        :return: FSUsersResp
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def list_fs_users_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['limit', 'offset', 'q', 'sort', 'security', 'fs_user_group_id', 'not_fs_user_group_id', 'available']  # noqa: E501
        all_params.append('async')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def update_fs_user_with_http_info(self, fs_user_id, body, **kwargs):  # noqa: E501
        ...
        all_params = ['fs_user_id', 'body']  # noqa: E501
        all_params.append('async')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
