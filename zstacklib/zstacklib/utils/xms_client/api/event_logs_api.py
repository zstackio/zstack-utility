...
class EventLogsApi(object):
    ...
    def list_event_logs(self, **kwargs):  # noqa: E501
        """list_event_logs  # noqa: E501

        List event logs  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.list_event_logs(async=True)
        >>> result = thread.get()

        :param async bool
        :param int limit: paging param
        :param int offset: paging param
        :param str status: status of event logs
        :param str resource_type: resource type of event logs
        ...
        if kwargs.get('async'):
            return self.list_event_logs_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.list_event_logs_with_http_info(**kwargs)  # noqa: E501
            return data

    def list_event_logs_with_http_info(self, **kwargs):  # noqa: E501
        """list_event_logs  # noqa: E501

        List event logs  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.list_event_logs_with_http_info(async=True)
        >>> result = thread.get()
        ...
        all_params = ['limit', 'offset', 'status', 'resource_type', 'duration_begin', 'duration_end', 'q', 'sort']  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='EventLogsResp',  # noqa: E501
