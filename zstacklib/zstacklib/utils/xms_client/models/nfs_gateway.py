...
class NFSGateway(object):
    ...
    def __init__(self, bucket_num=None, create=None, description=None, gateway_ip=None, gateway_name=None, host=None, id=None, mount_clients=None, mount_num=None, name=None, port=None, status=None, update=None):  # noqa: E501
