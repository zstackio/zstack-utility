...
def set_link_enable(ifname_or_index, namespace=None):
    set_link_attribute(ifname_or_index, namespace, state='up')

def set_link_disable(ifname_or_index, namespace=None):
    set_link_attribute(ifname_or_index, namespace, state='down')

@_no_error_do
def set_link_enable_no_error(*args, **kwargs):
    set_link_enable(*args, **kwargs)
    return True # if raise Exception, @_no_error_do will return False

@_no_error_do
def set_link_disable_no_error(*args, **kwargs):
    set_link_disable(*args, **kwargs)
    return True # if raise Exception, @_no_error_do will return False
