...
OS=''
IS_UBUNTU='n'
REDHAT_OS="CENTOS6 CENTOS7 RHEL7 HELIX7 HELIX8 ALIOS7 ISOFT4 KYLIN10 EULER20 UOS1020A NFS4 ROCKY8 OE2203 H2203SP1O L2003SP3O"
...
check_system(){
    ...
    echo ""
    trap 'traplogger $LINENO "$BASH_COMMAND" $?'  DEBUG
    cat /etc/*-release |egrep -i -h "centos |Helix|LinxOS|Red Hat Enterprise|Alibaba|NeoKylin|Kylin Linux Advanced Server release V10|openEuler|UnionTech OS Server release 20 \(kongzi\)|NFSChina Server release 4.0.220727 \(RTM3\)|Rocky Linux" >>$ZSTACK_INSTALL_LOG 2>&1
    if [ $? -eq 0 ]; then
        ...
        grep -qi 'LinxOS 6.0.99 EL20.03-SP3' /etc/system-release && OS="L2003SP3O"
