...
OS=''
IS_UBUNTU='n'
REDHAT_OS="CENTOS6 CENTOS7 RHEL7 HELIX7 HELIX8 ALIOS7 ISOFT4 KYLIN10 EULER20 UOS1020A NFS4 ROCKY8"
...
install_zops(){
    [[ x"$OS" != x"CENTOS7" && x"$OS" != x"HELIX7" && x"$OS" != x"KYLIN10" && x"$OS" != x"ROCKY8" ]] && return
