...
class SuspendVmInstanceAction(inventory.APISuspendVmInstanceMsg):
    def __init__(self):
        super(SuspendVmInstanceAction, self).__init__()
        self.sessionUuid = None
        self.out = None
    def run(self):
        if not self.sessionUuid:
            raise Exception('sessionUuid of action[SuspendVmInstanceAction] cannot be None')
        evt = api.async_call(self, self.sessionUuid)
        self.out = evt
        return self.out
...
class ResetRootVolumeFromImageAction(inventory.APIResetRootVolumeFromImageMsg):
    def __init__(self):
        super(ResetRootVolumeFromImageAction, self).__init__()
        self.sessionUuid = None
        self.out = None
    def run(self):
        if not self.sessionUuid:
            raise Exception('sessionUuid of action[ResetRootVolumeFromImageAction] cannot be None')
        evt = api.async_call(self, self.sessionUuid)
        self.out = evt
        return self.out
