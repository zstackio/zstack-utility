...
class StopVmInstanceSchedulerAction(inventory.APIStopVmInstanceSchedulerMsg):
    def __init__(self):
        super(StopVmInstanceSchedulerAction, self).__init__()
        self.sessionUuid = None
        self.out = None
    def run(self):
        if not self.sessionUuid:
            raise Exception('sessionUuid of action[StopVmInstanceSchedulerAction] cannot be None')
        evt = api.async_call(self, self.sessionUuid)
        self.out = evt
        return self.out
...
class StartVmInstanceSchedulerAction(inventory.APIStartVmInstanceSchedulerMsg):
    def __init__(self):
        super(StartVmInstanceSchedulerAction, self).__init__()
        self.sessionUuid = None
        self.out = None
    def run(self):
        if not self.sessionUuid:
            raise Exception('sessionUuid of action[StartVmInstanceSchedulerAction] cannot be None')
        evt = api.async_call(self, self.sessionUuid)
        self.out = evt
        return self.out
