...
APIQUERYCASSANDRAMSG_FULL_NAME = 'org.zstack.cassandra.APIQueryCassandraMsg'
class APIQueryCassandraMsg(object):
    FULL_NAME='org.zstack.cassandra.APIQueryCassandraMsg'
    def __init__(self):
        self.session = None
        self.timeout = None
