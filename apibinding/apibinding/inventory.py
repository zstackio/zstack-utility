...
class QueryObjectLoadBalancerInventory(object):
     ...
     EXPANDED_FIELDS = ['listeners','vmNicRefs','vip','listener','vmNic']
     QUERY_OBJECT_MAP = {
        'vip' : 'QueryObjectVipInventory',
...
class QueryObjectVmNicInventory(object):
     ...
     EXPANDED_FIELDS = ['eip','l3Network','vmInstance','portForwarding','loadBalancer','securityGroup']
     QUERY_OBJECT_MAP = {
        'eip' : 'QueryObjectEipInventory',
        'l3Network' : 'QueryObjectL3NetworkInventory',
        'loadBalancer' : 'QueryObjectLoadBalancerInventory',
...
class QueryObjectLoadBalancerVmNicRefInventory(object):
     ...
     EXPANDED_FIELDS = ['loadBalancer','vmNic']
     QUERY_OBJECT_MAP = {
        'loadBalancer' : 'QueryObjectLoadBalancerInventory',
        'vmNic' : 'QueryObjectVmNicInventory',
     }
