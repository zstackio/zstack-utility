...
class QueryObjectFusionstorBackupStorageMonInventory(object):
     PRIMITIVE_FIELDS = ['sshUsername','monPort','sshPassword','hostname','sshPort','backupStorageUuid','createDate','lastOpDate','__userTag__','__systemTag__']
     EXPANDED_FIELDS = []
     QUERY_OBJECT_MAP = {
     }
...
class QueryObjectSftpBackupStorageInventory(object):
     PRIMITIVE_FIELDS = ['status','state','hostname','sshPort','type','lastOpDate','url','totalCapacity','username','description','name','availableCapacity','uuid','createDate','__userTag__','__systemTag__']
...
class QueryObjectCephPrimaryStorageMonInventory(object):
     PRIMITIVE_FIELDS = ['sshUsername','monPort','primaryStorageUuid','sshPassword','hostname','sshPort','createDate','lastOpDate','__userTag__','__systemTag__']
     EXPANDED_FIELDS = []
     QUERY_OBJECT_MAP = {
     }

class QueryObjectFusionstorBackupStorageInventory(object):
     PRIMITIVE_FIELDS = ['fsid','poolName','status','state','sshPort','type','lastOpDate','url','totalCapacity','description','name','availableCapacity','uuid','createDate','__userTag__','__systemTag__']
...
class QueryObjectFusionstorPrimaryStorageMonInventory(object):
     PRIMITIVE_FIELDS = ['monPort','primaryStorageUuid','hostname','sshPort','createDate','lastOpDate','__userTag__','__systemTag__']
     EXPANDED_FIELDS = []
     QUERY_OBJECT_MAP = {
     }
