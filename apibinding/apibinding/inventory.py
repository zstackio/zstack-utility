...
APIDETACHPOLICESFROMUSERMSG_FULL_NAME = 'org.zstack.header.identity.APIDetachPolicesFromUserMsg'
class APIDetachPolicesFromUserMsg(object):
    FULL_NAME='org.zstack.header.identity.APIDetachPolicesFromUserMsg'
    def __init__(self):
        #mandatory field
