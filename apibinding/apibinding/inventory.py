...
APIQUERYECSINSTANCEREPLY_FULL_NAME = 'org.zstack.header.aliyun.ecs.APIQueryEcsInstanceReply'
class APIQueryEcsInstanceReply(object):
    FULL_NAME='org.zstack.header.aliyun.ecs.APIQueryEcsInstanceReply'
    def __init__(self):
        self.inventories = OptionalList()
        self.total = None
        self.success = None
...
api_names = [
    ...
    'APIQueryEcsInstanceMsg',
    'APIQueryEcsInstanceReply',
...
queryMessageInventoryMap = {
     ...
     'APIQueryEcsInstanceMsg' : QueryObjectEcsInstanceInventory,
