...
def install_kvm_pkg():
    def rpm_based_install():
        ...
        aarch64_alios7 = "bridge-utils chrony conntrack-tools cyrus-sasl-md5 device-mapper-multipath expect ipmitool iproute ipset \
                            ...
                            smartmontools sshpass usbutils vconfig wget audit dnsmasq qemu-kvm-ev collectd-virt"
