...
def install_kvm_pkg():
    def rpm_based_install():
        ...
        x86_64_rl84 = "bridge-utils chrony conntrack-tools cyrus-sasl-md5 device-mapper-multipath expect ipmitool iproute ipset \
                      ...
                      qemu-kvm collectd-virt collectd-disk edk2-ovmf edk2.git-ovmf-x64 mcelog MegaCli storcli Arcconf nvme-cli python-pyudev seabios-bin kernel-devel elfutils-libelf-devel"
