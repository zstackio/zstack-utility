...
if chroot_env == 'false':
    ...
    if distro in RPM_BASED_OS and major_version >= 7:
        command = "pgrep -f 'python -c from kvmagent import kdaemon' && pkill -USR2 -oef 'python -c from kvmagent import kdaemon' || true; systemctl stop zstack-kvmagent && systemctl start zstack-kvmagent && systemctl enable zstack-kvmagent"
