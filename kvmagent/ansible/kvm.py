...
if distro in RPM_BASED_OS:
    ...
    if zstack_repo != 'false':
        ...
        common_dep_list = "bridge-utils chrony conntrack-tools device-mapper-multipath expect iproute ipset usbredir-server iputils iscsi-initiator-utils libvirt libvirt-client libvirt-python lighttpd net-tools nfs-utils nmap openssh-clients pciutils python-pyudev pv rsync sed smartmontools sshpass usbutils vconfig wget %s %s %s" % (qemu_pkg, extra_pkg, common_update_list)
