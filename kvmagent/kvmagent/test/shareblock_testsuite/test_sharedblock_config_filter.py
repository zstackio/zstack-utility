...
class TestSharedBlockPlugin(TestCase, SharedBlockPluginTestStub):
    ...
    def test_sharedblock_config_filter(self):
        ...
        rsp = sharedblock_utils.sharedblock_config_filter(vgUuid, hostUuid, allSharedBlockUuids=[blockUuid])
        self.assertEqual(True, rsp.success, rsp.error)

        rsp = sharedblock_utils.sharedblock_config_filter(vgUuid, hostUuid, allSharedBlockUuids=[blockUuid, misc.uuid()])
        self.assertEqual(True, rsp.success, rsp.error)