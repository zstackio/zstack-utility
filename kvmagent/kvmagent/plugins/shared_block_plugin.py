...
#       3 in order to save time.
    ...
    def migrate_volumes(self, req):
        ...
        volumeInstallPath = filter(lambda s: s.snapshotUuid is None, cmd.migrateVolumeStructs)[0].currentInstallPath
        volumeInstallPath = translate_absolute_path_from_install_path(volumeInstallPath)
        ...
        for struct in cmd.migrateVolumeStructs:
            ...
            if volumeInstallPath == current_abs_path:
        ...
        try:
            ...
            for struct in cmd.migrateVolumeStructs:
                ...
                with lvm.RecursiveOperateLv(current_abs_path, shared=True):
                    ...
                    if volumeInstallPath == current_abs_path and cmd.provisioning == lvm.VolumeProvisioningStrategy.ThinProvisioning:
