    ...
    def installtdc(self, req):
        ...
        def installTdc(cmd):
            ...
            if startCmd.return_code != 0:
                ...
                e(False)
                if e.return_code != 0:
                    shell.call("export YUM0={}; yum --enablerepo=zstack-mn,qemu-kvm-ev-mn clean metadata")
                    shell.call("export YUM0={}; yum --disablerepo=* --enablerepo=zstack-mn,qemu-kvm-ev-mn install -y tdc-unified-8.2.0.release.el5.x86_64")
        ...
        def installVrbd():
            ...
            if lsModCmd.return_code != 0:
                ...
                if e.return_code != 0:
                    shell.call("export YUM0={}; yum --enablerepo=zstack-mn,qemu-kvm-ev-mn clean metadata")
                    shell.call("export YUM0={}; yum --disablerepo=* --enablerepo=zstack-mn,qemu-kvm-ev-mn install -y kernel-3.10.0-693.11.1.el7.x86_64-vrbd-1.0-0.1.release1.alios7.x86_64")
