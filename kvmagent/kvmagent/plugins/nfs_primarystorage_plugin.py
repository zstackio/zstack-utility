...
class NfsPrimaryStoragePlugin(kvmagent.KvmAgent):
    ...
    def upload_to_sftp(self, req):
        ...
        def upload():
            ...
            linux.scp_upload(cmd.backupStorageHostName, cmd.backupStorageSshKey, cmd.primaryStorageInstallPath, cmd.backupStorageInstallPath, sshPort=cmd.backupStorageSshPort)
