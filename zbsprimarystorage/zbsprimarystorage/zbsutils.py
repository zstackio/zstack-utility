...
VHOST_CHECK_READY_RETRIES = 40
VHOST_CHECK_READY_INTERVAL_SECONDS = 0.5
...
def wait_vhost_target_ready(ip, port, username, password, retries=VHOST_CHECK_READY_RETRIES,
                            interval=VHOST_CHECK_READY_INTERVAL_SECONDS):
